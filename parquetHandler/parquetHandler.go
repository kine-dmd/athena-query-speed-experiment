...
func MakeParquetFile(filePath string) (*ParquetFileHandler, error) {
	...
	parquetWriter, err := ParquetWriter.NewParquetWriter(fileWriter, new(appleWatch3Row.AppleWatch3Row), 1)
	if err != nil {
...
func (parqFileHandler *ParquetFileHandler) WriteRow(row appleWatch3Row.AppleWatch3Row) error {
